...
namespace GoodsExchange.Data.Migrations
{
    ...
    [Migration("20240618160523_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GoodsExchange.Data.Models.Report", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ReportId = new Guid("9476090d-9dfa-45d1-9485-985cd4dbaa03"),
                        ...
                        new
                        {
                            ReportId = new Guid("fa9f151e-4927-4390-bbef-bb1f87eb2da2"),
                        ...
                        new
                        {
                            ReportId = new Guid("87604f1f-1598-4288-8b6a-c33ca56e5cfd"),
                        ...
                        new
                        {
                            ReportId = new Guid("3e5c05b7-089b-4f46-a9d3-29205a2a4504"),
                        ...
                        new
                        {
                            ReportId = new Guid("0e8403f4-2ac3-478a-b91c-5ed716dba653"),
                        ...
                        new
                        {
                            ReportId = new Guid("77b5c9de-47e9-45a9-be10-32e4de9d9655"),
                        ...
                        new
                        {
                            ReportId = new Guid("b88627d0-6699-46fc-a0ba-bc200da60151"),
                        ...
                        new
                        {
                            ReportId = new Guid("45b06421-5a4d-41be-9054-7499126b9873"),
                        ...
                        new
                        {
                            ReportId = new Guid("d22ad452-1794-490b-9c12-12bd035ae40a"),
                        ...
                        new
                        {
                            ReportId = new Guid("48d62029-11c6-45b7-87f9-b0543de297d4"),
            ...
            modelBuilder.Entity("GoodsExchange.Data.Models.UserToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("GoodsExchange.Data.Models.UserToken", b =>
                {
                    b.HasOne("GoodsExchange.Data.Models.User", null)
                        .WithMany("usertokens")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
